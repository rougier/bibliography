...
\printbibliography[heading=subbibliography, title={Book \& Thesis},    filter=book]
\printbibliography[heading=subbibliography, title={Book Chapters},     filter=chapter]
\printbibliography[heading=subbibliography, title={Conferences},       filter=conference]
\printbibliography[heading=subbibliography, title={Science Outreach},  filter=popular]
\printbibliography[heading=subbibliography, title={Tutorials},         filter=tutorial]
\printbibliography[heading=subbibliography, title={Invited Talks \& Lectures},
                                                                       filter=invited]
